...
<html>
    ...
    <body>
        ...
        <div class="Banner container text-center col-lg-12">
            <div class="display-1" style="padding-top:50px;">E-Commerce Website Development..</div>
            <div class="fs-3">An E-commerce website can help you grow sales more than 19 % a year</div>
            <div class="fs-6" style="margin:60px">Join us today! Get help directly from E-Commerse Experts...</div><br>
        ...
        <div class="container row Container1">
            ...
            <div class="col-lg-6 col-sm-12">
                <div class="display-2">About E-commerce Post 1...</div>
        ...
        <div class="container text-center Container2">
            <div class="display-4 cont2_h1">Customized E-Commerce Website = More Inventory + More Sales</div>
            <div class="fs-5 cont2_p">We are today’s Digital Agency with the vision to propel your services for tomorrow. We provide full Design Services,
             ...
             <div class="row imgs">
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img1">E-Commerse Stratergy</a>
                <!--<div class="col-1 col-sm-12"></div>-->
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img2">E-commerce UI/UX Design</a>
                <!--<div class="col-1 col-sm-12"></div>-->
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img3">E-commerce App Development</a>
                <!--<div class="col-1 col-sm-12"></div>-->
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img4">Mobile Responsive Design</a>
             </div>
             <div class="row imgs">
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img1">Payment Gateway Integration</a>
                <!--<div class="col-1 col-sm-12"></div>-->
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img2">Delivery API Integration</a>
                <!--<div class="col-1 col-sm-12"></div>-->
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img3">Maintenance & Support</a>
                <!--<div class="col-1 col-sm-12"></div>-->
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img4">E-commerce SEO</a>
             </div>
        </div>
        <!--------------------------------------------------------Clients--------------------------------------------------------------->
