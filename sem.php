...
<html>
    ...
    <body>
        ...
        <div class="Banner container text-center col-lg-12">
            <div class="display-1" style="padding-top:50px;">Search Engine Marketing</div>
            <div class="fs-3">89% of customers begin their buying process with a search engine.</div>
            <div class="fs-6" style="margin:60px">Join us today! Get help directly from SEM Experts...</div><br>
            <a href="#form_tofill" class="btn btn-dark" style="margin:60px 60px 0px; padding: 20px">Speak to our SEM Experts</a>
        </div>
        <!--------------------------------------------------------About SMM--------------------------------------------------------------->
        <div class="container row Container1">
            <div class="col-lg-5 col-sm-12">
                <img src="../../images/sem1.png" alt="SEM_imp">
            </div>
            <div class="col-lg-1 col-sm-12"></div>
            <div class="col-lg-6 col-sm-12">
                <div class="display-2">About SEM Post 1...</div>
                ...
                <a href="#form_tofill" class="btn btn-primary cont2_a">Score your website now!</a>
            </div>
        </div>
        <!--------------------------------------------------------WWHBGS--------------------------------------------------------------->
        <div class="container text-center Container2">
            <div class="display-4 cont2_h1">Googling made easy!</div>
        ...
        <div class="container Container3 row">
            ...
            <div class="row why_us1 w3-container w3-center w3-animate-right col-lg-6 col-sm-12">
                <img src="../../images/sem2.png" alt="SMM">
            </div>
        </div>
        <!--------------------------------------------------------HCWHY--------------------------------------------------------------->
