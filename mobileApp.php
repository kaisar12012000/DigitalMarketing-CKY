...
<html>
    ...
    <body>
        ...
        <div class="Banner container text-center col-lg-12">
            <div class="display-1" style="padding-top:50px;">Mobile App Development...</div>
        ...
        <div class="container row Container1">
            ...
            <div class="col-lg-6 col-sm-12">
                <div class="display-2">About Mobile App Development Post 1...</div>
        ...
        <div class="container text-center Container2">
            <div class="display-4 cont2_h1">Generate More Sales From Mobile Users!</div>
            <div class="fs-5 cont2_p">We are today’s Digital Agency with the vision to propel your services for tomorrow. We provide full Design Services,
             ...
             <div class="row imgs">
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img1">Competitor Analysis</a>
                <!--<div class="col-1 col-sm-12"></div>-->
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img2">Information Architecture Design</a>
                <!--<div class="col-1 col-sm-12"></div>-->
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img3">UI & UX Prototyping</a>
                <!--<div class="col-1 col-sm-12"></div>-->
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img4">Development, Maintenance & Support</a>
             </div>
        </div>
        <!--------------------------------------------------------Clients--------------------------------------------------------------->
