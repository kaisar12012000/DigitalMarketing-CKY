...
<html>
    ...
    <body>
        ...
        <div class="banner text-center">
            <h1 class="display-1">WEBSITE DESIGN AND DEVELOPMENT..</h1>
            <p class="fs-3">The entire world is on the internet. How long will you relly on your old fashioned ways?</p>
            <small class="fs-6" style="margin:60px">Join us today! Get help directly from Web Dev's...</small><br>
            <a href="#" class="btn btn-dark" style="margin:60px 60px 0px; padding: 20px">Speak to our Web Dev's</a>
        </div>
        <!-----------------------------------------------------About Web Dev--------------------------------------------------------------->
        <div class="container row container-1">
            ...
            <div class="col-1"></div>
            <div class="col-6">
                <h1 class="display-2">About Web Design/Dev Post 1...</h1>
                ...
                <a href="#" class="btn btn-primary cont2_a">Get yourself a website now!</a>
            </div>
        </div>
        <!-------------------------------------------------WWHYBAAS-------------------------------------------------------------------->
        <div class="container container-2 text-center">
            ...
            <p class="fs-5 cont2_p">We are an organization of inovative people who strive for the betterment of our clients.
             ...
             <div class="row imgs">
                <a href="#" class="col-2 rounded-circle img1">Web Content Creation</a>
                <div class="col-1"></div>
                <a href="#" class="col-2 rounded-circle img2">Web Designing</a>
                <div class="col-1"></div>
                <a href="#" class="col-2 rounded-circle img3">Full stack dev</a>
                <div class="col-1"></div>
                <a href="#" class="col-2 rounded-circle img4">Domain and DB</a>
             </div>
             <div class="row imgs2">
                <a href="#" class="col-2 rounded-circle img1">Web apps</a>
                <div class="col-1"></div>
                <a href="#" class="col-2 rounded-circle img2">Trending functions</a>
                <div class="col-1"></div>
                <a href="#" class="col-2 rounded-circle img3">Full access on DB</a>
                <div class="col-1"></div>
                <a href="#" class="col-2 rounded-circle img4">You write zero code</a>
             </div>
        </div>
        <!--------------------------------------------------------Clients--------------------------------------------------------------->
