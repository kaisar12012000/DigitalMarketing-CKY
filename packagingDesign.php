...
<html>
    ...
    <body>
        ...
        <div class="Banner container text-center col-lg-12">
            <div class="display-1" style="padding-top:50px;">Packaging Design...</div>
            <div class="fs-3">Around 80% of the consumers say their purchasing decision is influenced by the packaging design.</div>
        ...
        <div class="container row Container1">
            ...
            <div class="col-lg-6 col-sm-12">
                <div class="display-2">About Packaging design Post 1...</div>
        ...
        <div class="container text-center Container2">
            ...
            <div class="fs-5 cont2_p">We are today’s Digital Agency with the vision to propel your services for tomorrow. We provide full Design Services,
             ...
             <div class="row imgs">
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img1">Product Knowledge Research</a>
                <!--<div class="col-1 col-sm-12"></div>-->
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img2">Competition Analysis</a>
                <!--<div class="col-1 col-sm-12"></div>-->
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img3">Packaging objective</a>
                <!--<div class="col-1 col-sm-12"></div>-->
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img4">Packaging architecture</a>
             </div>
             <div class="row imgs">
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img1">Visual Design</a>
                <!--<div class="col-1 col-sm-12"></div>-->
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img2">Mockup Design</a>
                <!--<div class="col-1 col-sm-12"></div>-->
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img3">User testing/Feedback</a>
                <!--<div class="col-1 col-sm-12"></div>-->
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img4">Product launch</a>
             </div>
        </div>
        <!--------------------------------------------------------Clients--------------------------------------------------------------->
