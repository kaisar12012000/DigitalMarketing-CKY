...
<html>
    <head>
        ...
        <title>Space Design & Visual Branding...</title>
    ...
    <body>
        ...
        <div class="Banner container text-center col-lg-12">
            <div class="display-1" style="padding-top:50px;">Space Design & Visual Branding...</div>
            <div class="fs-3">Consistent branding across all channels increases revenue by 23%.</div>
        ...
        <div class="container row Container1">
            <div class="col-lg-5 col-sm-12">
                <img src="../../images/space1.png" alt="space&visuals_imp">
            </div>
            <div class="col-lg-1 col-sm-12"></div>
            <div class="col-lg-6 col-sm-12">
                <div class="display-2">About Let’s Give a Shout out to Your Brand! Post 1...</div>
        ...
        <div class="container text-center Container2">
            <div class="display-4 cont2_h1">Convey The Unspoken Words!...</div>
            <div class="fs-5 cont2_p">We are today’s Digital Agency with the vision to propel your services for tomorrow. We provide full Design Services, Social Media strategy to execution, Digital Media services with an SEO driven focus on Content.</div>
             ...
             <div class="row imgs">
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img1">Design Strategy</a>
                <!--<div class="col-1 col-sm-12"></div>-->
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img2">Communication Design</a>
                <!--<div class="col-1 col-sm-12"></div>-->
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img3">Print & Fabrication Selection</a>
                <!--<div class="col-1 col-sm-12"></div>-->
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img4">Application & Maintenance</a>
             </div>
        </div>
        <!--------------------------------------------------------Clients--------------------------------------------------------------->
        ...
        <div class="container Container3 row">
            ...
            <div class="row why_us1 w3-container w3-center w3-animate-right col-lg-6 col-sm-12">
                <img src="../../images/space2.png" alt="CM">
            </div>
        </div>
        <!--------------------------------------------------------HCWHY--------------------------------------------------------------->
