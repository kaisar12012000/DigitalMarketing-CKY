...
<html>
    <head>
        ...
        <title>ERP CRM CMS Development...</title>
    ...
    <body>
        ...
        <div class="Banner container text-center col-lg-12">
            <div class="display-1" style="padding-top:50px;">ERP CRM CMS..</div>
            <div class="fs-3">63% of millennials prefer to make purchases on mobile apps</div>
        ...
        <div class="container row Container1">
            ...
            <div class="col-lg-6 col-sm-12">
                <div class="display-2">About ERP CRM CMS-Post 1...</div>
        ...
        <div class="container text-center Container2">
            <div class="display-4 cont2_h1">A Successful ERP/CRM/CMS Strategy = Ultimate Boost!</div>
            <div class="fs-5 cont2_p">We are today’s Digital Agency with the vision to propel your services for tomorrow. We provide full Design Services,
             ...
             <div class="row imgs">
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img1">Business Requirement</a>
                <!--<div class="col-1 col-sm-12"></div>-->
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img2">Functional Modules</a>
                <!--<div class="col-1 col-sm-12"></div>-->
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img3">Information Architect</a>
                <!--<div class="col-1 col-sm-12"></div>-->
                <a href="#" class="col-lg-2 col-sm-12 rounded-circle img4">Wireframe & Prototypes</a>
             </div>
        </div>
        <!--------------------------------------------------------Clients--------------------------------------------------------------->
